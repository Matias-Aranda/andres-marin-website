        ...
        <div className='w-[600px] mt-10 py-15 px-20 border border-primary rounded-md bg-background/50 bg-opacity-50 backdrop-blur-lg flex flex-col'>
            ...
            <form className='flex flex-col gap-6 mt-5'>
                <label className='text-base text-white leading-none flex flex-col gap-4'>
                    Nombre
                    <input type="text" required className='h-[55px] border border-primary p-2 rounded text-white' />
                </label>
                <label className='text-base text-white leading-none flex flex-col gap-4'>
                    Email
                    <input type="email" required className='h-[55px] border border-primary p-2 rounded text-white' />
                </label>
                <label className='text-base text-white leading-none flex flex-col gap-4'>
                    Contraseña
                    <input type="password" required className='h-[55px] border border-primary p-2 rounded text-white' />
                </label>
                <button className='text-base text-background px-8 py-4 bg-primary rounded-md cursor-pointer'>Registrarse</button>
