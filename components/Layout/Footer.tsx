...
const Footer = () => {
  ...
  return (
    <div className='flex items-center justify-between py-10 sm:py-15 px-10 sm:px-15 lg:px-25 border-t border-primary'>
      {loading && <LoadingScreen />}
      <div className='flex flex-col items-start justify-center'>
        <img src="/footer_logo.svg"  className='h-[40]'/>
        <p className='text-neutral-50 leading-relaxed w-4/5 my-6 md:my-12'>Las explicaciones más completas del Simracing en Habla Hispana.</p>
        <p className='text-base text-[rgba(255,255,255,0.3)]'>Copyright © 2025 P1 Academy. All Rights Reserved.</p>
      </div>
      <div className='flex flex-col items-center justify-center hidden md:block text-left'>
        ...
        <ul className='flex flex-col items-start justify-center p-0 m-0 list-none gap-6 '>
          <li className='text-neutral-50 leading-relaxed text-base'>
