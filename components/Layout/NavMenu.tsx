...
const NavMenu: React.FC<NavMenuProps> = ({ setShown, setLoading }) => {
  ...
  return (
    <div className='h-screen w-full flex fixed justify-end top-0 left-0 z-10'>
        ...
        <div ref={modalRef} className='bg-background/50 w-[40%] backdrop-blur flex flex-col items-start justify-center gap-6 border-l border-l-primary p-10 z-10 relative'>
