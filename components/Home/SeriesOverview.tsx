...
const SeriesOverview = () => {
  return (
    <div className='flex flex-col lg:flex-row items-center justify-center pb-30 p-15 sm:px-30 overflow-hidden gap-6 bg-gradient-to-t from-slate-500/5 to-background to-70% px-10'>
