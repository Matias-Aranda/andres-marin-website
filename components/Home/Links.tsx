  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-2 gap-0'>
      <div className='group aspect-[4/3] flex flex-col items-center justify-end text-center pb-[10%] relative overflow-hidden'>
        ...
        <h3 className='text-neutral-50 text-[clamp(1.5rem,3vw,3rem)] font-display mx-0 my-[3%] leading-none z-2'>Andrés Marín</h3>
      ...
      <div className='group aspect-[4/3] flex flex-col items-center justify-end text-center pb-[10%] relative overflow-hidden'>
        ...
        <h3 className='text-neutral-50 text-[clamp(1.5rem,3vw,3rem)] font-display mx-0 my-[3%] leading-none z-2'>Servicios</h3>
      ...
      <div className='group aspect-[4/3] flex flex-col items-center justify-end text-center pb-[10%] relative overflow-hidden'>
        ...
        <h3 className='text-neutral-50 text-[clamp(1.5rem,3vw,3rem)] font-display mx-0 my-[3%] leading-none z-2'>Redes Sociales</h3>
      ...
      <div className='group aspect-[4/3] flex flex-col items-center justify-end text-center pb-[10%] relative overflow-hidden'>
        ...
        <h3 className='text-neutral-50 text-[clamp(1.5rem,3vw,3rem)] font-display mx-0 my-[3%] leading-none z-2'>Sponsor Me</h3>
