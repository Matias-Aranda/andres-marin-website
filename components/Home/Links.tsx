...
const Links = () => {
  return (
    <div className='gap-0 grid grid-cols-1 sm:grid-cols-2 border-primary border-t'>
      <Link href="/about" className='group relative flex flex-col justify-end items-center pb-[10%] aspect-[4/3] overflow-hidden text-center'>
        <img
          src="/about_bg.png"
          alt=""
        ...
        <p className='z-2 flex items-center gap-2 text-primary font-body-light-italic'>LEER MÁS <img className='h-5' src="/arrow_icon.svg"/></p>
      </Link>
      <Link href="/services" className='group relative flex flex-col justify-end items-center pb-[10%] aspect-[4/3] overflow-hidden text-center'>
        <img
          src="/services_bg.png"
          alt=""
          className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-300 transform"
      ...
      <Link href="/socials" className='group relative flex flex-col justify-end items-center pb-[10%] aspect-[4/3] overflow-hidden text-center'>
        <img
          src="/socials_bg.png"
          alt=""
          className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-300 transform"
      ...
      <Link href="/sponsors" className='group relative flex flex-col justify-end items-center pb-[10%] aspect-[4/3] overflow-hidden text-center'>
        <img
          src="/sponsors_bg.png"
          alt=""
          className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-300 transform"
