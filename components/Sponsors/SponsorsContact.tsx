...
const SponsorsContact = () => {
  return (
    <div className='h-screen flex items-center justify-center p-30 gap-20 bg-[url(/contact_bg.png)] bg-cover bg-center relative'>
        ...
        <form className='w-[40%] py-15 px-20 border border-primary rounded-md bg-background/50 bg-opacity-50 backdrop-blur-lg flex flex-col gap-6'>
            ...
            <label className='text-base text-white leading-none flex flex-col gap-4'>
                Mensaje
                <textarea className='h-[200px] border border-primary p-2 rounded text-white resize-none' />
            </label>
