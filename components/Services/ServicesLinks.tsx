...
const ServicesLinks = () => {
  return (
    <div className='flex flex-col lg:grid grid-cols-2 gap-0'>
      <div className='aspect[4/3] flex flex-col items-center justify-center text-center py-15 bg-[url(/fast_bg.png)] bg-cover bg-center bg-no-repeat'>
        <h3 className='text-neutral-50 text-[clamp(4rem,12vw,6rem)] font-display mx-0 my-4 leading-none'>Be <span className='text-primary'>Fast.</span></h3>
      </div>
      <div className='aspect[4/3] flex flex-col items-start justify-center text-left px-[8%] 2xl:px-[15%] py-15 bg-background bg-cover bg-center bg-no-repeat gap-1 sm:gap-6'>
        <h3 className='text-neutral-50 text-[64px] xl:text-[80px] text-left font-display-condensed mx-0 my-4 leading-none uppercase'><span className='text-primary'>Coaching</span> session 1v1</h3>
        ...
        <ul className='flex flex-col items-start text-left my-6 gap-3'>
            <li className='text-neutral-50 text-base xl:text-xl font-body-light-italic flex items-start gap-2 leading-relaxed'><img src="/check_icon.svg" className='mt-1'/> Sesión personalizada de aproximadamente 1 hora</li>
      ...
      <div className='aspect[4/3] order-3 lg:order-4 flex flex-col items-center justify-center text-center py-15 bg-[url(/precise_bg.png)] bg-cover bg-center bg-no-repeat'>
        <h3 className='text-neutral-50 text-[clamp(4rem,12vw,6rem)] font-display mx-0 my-4 leading-none'>Be <span className='text-primary'>Precise.</span></h3>
      </div>
    </div>
  )
}
